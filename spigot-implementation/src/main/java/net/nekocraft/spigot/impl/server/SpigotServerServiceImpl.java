package net.nekocraft.spigot.impl.server;
...
public class SpigotServerServiceImpl extends net.nekocraft.common.impl.service.SpigotServerServiceImpl implements Service {
        ...
        if (!isEnabled()) {
            ...
            bukkitTask = new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    serverMap.put(spigotServer.getId(), spigotServer);
                }
